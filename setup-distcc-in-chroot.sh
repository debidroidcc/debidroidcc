...
sed -i -e 's|PATH=/usr/local/sbin|PATH=/usr/local/cross-cc/libexec/gcc/i686-pc-linux-gnu/4.6.2:/usr/local/cross-cc/i686-pc-linux-gnu/bin:/usr/local/cross-cc/bin:/usr/local/sbin|g' /etc/init.d/distcc
